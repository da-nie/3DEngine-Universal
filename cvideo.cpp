...
//----------------------------------------------------------------------------------------------------
void CVideo::GetScreenSize(long &width,long &height)
{
 width=ScreenWidth;
 height=ScreenHeight;
}
...
//----------------------------------------------------------------------------------------------------
void CVideo::GetWindowSize(long &width,long &height)
{
 width=ScreenWidth;
 height=WindowHeight;
}
...
//получить центр окна
//----------------------------------------------------------------------------------------------------
void CVideo::GetWindownCenter(long &xcenter,long &ycenter)
{
 xcenter=WindowXCenter;
 ycenter=WindowYCenter;
}
//----------------------------------------------------------------------------------------------------
//получить указатель на видеобуфер
//----------------------------------------------------------------------------------------------------
void CVideo::GetVideoPointer(unsigned long* &vptr,unsigned long &linesize)
{
 linesize=LineSize;
 vptr=VideoBuffer; 
}
//----------------------------------------------------------------------------------------------------
//задать указатель на видеобуфер  
//----------------------------------------------------------------------------------------------------
void CVideo::SetVideoPointer(unsigned long* vptr,unsigned long linesize)
{
 VideoBuffer=vptr;
 LineSize=linesize;
}
...
//----------------------------------------------------------------------------------------------------
void CVideo::PutSymbol(unsigned long x,unsigned long y,char symbol,unsigned long color)
{ 
 if (VideoBuffer==NULL) return;
 ...
 for(unsigned long ys=0;ys<FONT_HEIGHT;ys++)
 {
  ...
  {   
   ...
   unsigned long *v_ptr=VideoBuffer+x+xs+(y+ys)*LineSize;
...
//----------------------------------------------------------------------------------------------------
void CVideo::PutString(unsigned long x,unsigned long y,const char *string,unsigned long color)
{
